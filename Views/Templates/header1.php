...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-danger ftco_navbar ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="<?php echo base_url; ?>">Brayner<span>Car</span></a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="<?php echo base_url . 'carrito_compras'; ?>" class="nav-link">MAS</a></li>
